    ...
    with classification_page:
        with gr.Row():
            ...
            with gr.Column():
                ...
                gr.Image("/mnt/data/image.png", elem_id="uploaded-image") # change to document preview 
                viewFull_button = gr.Button("View full document here")
                with gr.Row():
            ...
            with gr.Column():
                ...
                gr.Markdown("## Author(s)")
                gr.Markdown("## Posted at")
